# Convolutional Occupancy Networks Docker

This repo is the docker build of Convolutional Occupancy Networks Docker 
[Original Repo](https://github.com/autonomousvision/convolutional_occupancy_networks)
